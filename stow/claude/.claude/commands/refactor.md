...
Refactor the code I point you to so it conforms to this project's standards — without
...
- Apply the `writing-clean-code` and `naming-things` skills: small single-purpose
  functions, intention-revealing names, early returns, no dead code.
- Apply the `structuring-architecture` skill: correct layering, no new circular
